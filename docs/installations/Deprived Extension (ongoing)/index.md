...
<div style="display: flex; gap: 1rem; align-items: stretch; margin: 1rem 0 0.9rem 0;">
	<div style="flex: 0 0 62%; min-width: 0; display: flex; flex-direction: column; justify-content: space-between;">
		...
		<img src="./2.jpg" alt="Deprived Extension image 2" style="width: 100%; height: auto; display: block; margin-top: 0.5rem;" />
	</div>
	<div style="flex: 0 0 36%; min-width: 220px; display: flex; align-items: flex-end;">
		<img src="./1.jpg" alt="Deprived Extension image 1" style="width: 100%; height: auto; display: block; margin: 0;" />
	</div>
</div>

<div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; margin: 0 0 1.2rem 0;">
	<img src="./3.jpg" alt="Deprived Extension image 3" style="width: min(440px, 100%); height: auto; display: block;" />
	<img src="./5.jpg" alt="Deprived Extension image 5" style="width: min(440px, 100%); height: auto; display: block;" />
</div>
